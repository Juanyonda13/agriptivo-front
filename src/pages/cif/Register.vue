          ...
          <v-form ref='form' v-model='validForm'>
            <v-row>
              <v-col cols='12' sm='6' md='12'>
                <v-text-field v-model='name_cif' label='Nombre de tu Actividad*' :rules='processRules' maxlength='50'
                  counter variant='outlined' type='text'></v-text-field>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols='12' sm='6' md='12'>
                <v-text-field v-model='price_cif' label='Costo*' :rules='processRules' maxlength='50' counter
